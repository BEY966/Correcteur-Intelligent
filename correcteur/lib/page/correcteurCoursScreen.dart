...
class _MainScreenState extends State<MainScreen> {
  ...
  final List<Widget> _pages = [
    const Center(child: Text('Acceuil', style: TextStyle(fontSize:24))),
    const Center(child: Text('Cours', style: TextStyle(fontSize:24))),
    const optionScreen(),
...
class CorrecteurCoursScreen extends StatefulWidget {
  const CorrecteurCoursScreen({super.key});

  @override
  State<CorrecteurCoursScreen> createState() => _CorrecteurCoursScreenState();
}

class _CorrecteurCoursScreenState extends State<CorrecteurCoursScreen> {
      ...
      'contents': [
        {
          'parts': [
            {
              'text':
                  "Voici une le titre du cours: $prompt Generes  une liste pour  un eleve de terminale série D au Cameroun de ${_controllerNQuestion.text} questions sur ce cours. Sans commentaire, et sans rien afficher en gras, juste des questions"
            }
          ]
        }
      ],
          ...
          content: const Column(
              ...
              children: [
                Text("1. Entrer l'intitulé du chapitre lu",
                    style: TextStyle(color: Colors.black)),
                SizedBox(height: 8),
                Text('2. Entrer le nombre de questions"',
                    style: TextStyle(color: Colors.black)),
                SizedBox(height: 8),
              ]),
          actions: [
...
/*
  ...
  Future _generateQuestions() {
    return showDialog(
        context: context,
        builder: (context) => AlertDialog(
              title: Text("Les questions sur : ${_controllerCours.text}",
              ...
              content:  Container(
                ...
                child:  ListView.builder(
                  padding:  const EdgeInsets.all(8.0),
                  itemCount: int.parse(selectedValue1!),
                  ...
                  onPressed: () {
                    ...
                    Future.delayed(const Duration(milliseconds: 100), () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CorrecteurScreen(
                            questions: _response.split("?"),
                          ),
                        ),
                      );
                    });
